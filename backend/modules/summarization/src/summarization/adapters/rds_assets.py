...
class RdsS3AssetReader:
    ...
    def _client(self) -> Any:
        if self._s3 is None:
            ...
            # AWS_ENDPOINT_URL_S3 (boto3's own override var) wins when set — that's how local
            # serving points this reader at MinIO; unset in prod, so the regional URL still rules.
